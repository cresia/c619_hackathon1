...
function displayDice() {
  ...
  if(random === 1){
    randomNumber = $("#randomNum").css({
      'background-image': "url('https://banner2.kisspng.com/20180219/vcw/kisspng-dice-clip-art-dice-1-5a8b073c5aadb9.5396521215190607963714.jpg')",
      'width':'10%',
      'height':'10%',
      'position': "absolute"
    })
  ...
  randomNumber = $("#randomNum").css({
    'background-image': 'url("http://clipartmag.com/images/dice-images-1-6-33.gif")',
    'width': '10px',
    'height': '10px',
    'position': "absolute",
  });
